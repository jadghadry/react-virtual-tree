...
import React, { forwardRef, useMemo, useReducer, useEffect, useRef, useLayoutEffect, useImperativeHandle, useCallback } from 'react';
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "rt-tree-label", children: renderItem ? renderItem(item) : item.label })
        ]
      }
    );
  },
...
export { CheckedState, Engine, Tree };
